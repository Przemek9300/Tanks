...
class Enemy(TankBase):
    ...
    def __init__(self, pos ):
        ...
        self.fireSpeed = Setting.FireSpeed
        self.changeImage()
    ...
    def changeImage(self):
        if self.state == self.states[0]:
            self.image = pygame.image.load("img/enemyUP.png")
        if self.state == self.states[1]:
            self.image = pygame.image.load("img/enemyLEFT.png")
        if self.state == self.states[2]:
            self.image = pygame.image.load("img/enemyRIGHT.png")
        if self.state == self.states[3]:
            self.image = pygame.image.load("img/enemyDOWN.png")
    def changeDir(self):
